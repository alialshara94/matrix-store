    ...
    <main className="min-h-screen bg-gradient-to-b from-primary/20 to-primary/40 flex flex-col items-center justify-between p-4">
      <div className="w-full max-w-3xl flex flex-col items-center justify-center py-12 md:py-24">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          ...
          <h1 className="text-4xl font-bold text-primary mt-5 mb-2 text-right direction-rtl" dir="rtl">ادخل المصفوفة الآن وامتلك أحدث الأجهزة الإلكترونية!</h1>
          <p className="text-lg text-gray-700">موجودين على كل المنصات اختار الي يعجبك واطلب</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl">
          ...
          <SocialButton
            href="https://www.tiktok.com/@matr1xstore"
      ...
      <footer className="w-full text-center py-4 text-sm text-gray-600">
        © {new Date().getFullYear()} Matrix Store. All rights reserved.
      </footer>
    </main>
  )
}
